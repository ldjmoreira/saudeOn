function doPreview2(event,id)
{
    event.preventDefault()
    
    if($(`#inputmonitor-${id}`).val() == "" ) {
        alert("digite o ID do monitor e depois clique em selecionar")
        return;
    }
...
(function () {
    ...
    var proprerty_ = document.getElementsByClassName("_filho _nav-monitoramento-filho");//aparecerFilhos
    class_toggle(proprerty_,"w3-hide","w3-show");
  
    btnPacienteCor1 = document.getElementsByClassName("_nav-item-monitoramento");//cor
    ...
    class_add_toggle(btnPacienteCor1,"verde-568132");
      ...
      var proprerty_ = document.getElementsByClassName("_demoMon2");//aparecerFilhos
