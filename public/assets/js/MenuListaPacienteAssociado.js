(function () {
    ...
    btnUpPaciente = document.getElementById("ico-monitoramento");
    class_toggle_by_id(btnUpPaciente,"icofont-simple-down","icofont-simple-up");

        proprerty_ = document.getElementsByClassName("_nav-monitoramento-filho");// _demoAcc
    ...
    class_add_toggle(btnPacienteCor1,"verde-92D050");
        ...
        btnPacienteCor1 = document.getElementsByClassName("_nav-monitoramento-filho");
    class_add_toggle(btnPacienteCor1,"verde-568132");
     
    var proprerty_ = document.getElementsByClassName("_demoMon3");//aparecerFilhos
