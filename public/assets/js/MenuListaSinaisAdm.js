(function () {
  ...
  var btnUpPaciente = document.getElementById("ico-paciente");
  class_toggle_by_id(btnUpPaciente,"icofont-simple-down","icofont-simple-up");

  var proprerty_ = document.getElementsByClassName("_nav-paciente-filho");
  ...
  class_add_toggle(btnPacienteCor1,"verde-568132");
    ...
    var proprerty_ = document.getElementsByClassName("_demoAcc8");//aparecerFilhos
