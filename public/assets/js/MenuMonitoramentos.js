(function () {
  ...
  btnUpPaciente = document.getElementById("ico-paciente");
  class_toggle_by_id(btnUpPaciente,"icofont-simple-down","icofont-simple-up");

      proprerty_ = document.getElementsByClassName("_nav-paciente-filho");// _demoAcc
  class_toggle(proprerty_,"w3-hide","w3-show");

  btnPacienteCor1 = document.getElementsByClassName("_nav-item-paciente");
  class_add_toggle(btnPacienteCor1,"verde-92D050");
  
      btnPacienteCor1 = document.getElementsByClassName("_nav-paciente-filho");
  class_add_toggle(btnPacienteCor1,"verde-568132");
   
  var proprerty_ = document.getElementsByClassName("_demoAccMon");//aparecerFilhos
