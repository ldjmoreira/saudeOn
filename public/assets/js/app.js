...
*/
  ...
  function class_add_toggle(params,string_name) {
    ...
    function class_toggle_right(params,string_name,string_replace) {
      for(let elem of params) {
        if (elem.className.indexOf(string_name) != -1) {
          elem.className = elem.className.replace(string_name,string_replace);
  ...
  "_nav-item-agenda","_nav-item-programacao","_nav-item-atencaoDom","_nav-item-administrativo"]
  const var_22=["ico-monitoramento","ico-paciente","ico-agenda","ico-programacao","ico-atencaoDom","ico-adm"]
  const var_33=["_nav-monitoramento-filho","_nav-paciente-filho","nav-agenda-filho","nav-programacao-filho","nav-atencao-filho","_nav-administrativo-filho"]
  const var_44=["_nav-monitoramento-filho","_nav-paciente-filho","nav-agenda-filho","nav-programacao-filho","nav-atencao-filho","_nav-administrativo-filho"]
    
    for(i in var_22) {
        if(var_22[i] != var_2 ){
        btnUpPaciente = document.getElementById(var_22[i]);//seta
        console.log(btnUpPaciente)
        if(btnUpPaciente != null ){
...
function drop_programacao(var_1,var_2,var_3,var_4) {

  menu_close(var_1,var_2,var_3,var_4);

  var btnUpPaciente = document.getElementById("ico-programacao");
  class_toggle_by_id(btnUpPaciente,"icofont-simple-down","icofont-simple-up");

  var proprerty_ = document.getElementsByClassName("_filho nav-programacao-filho");//aparecerFilhos
  class_toggle(proprerty_,"w3-hide","w3-show");

  var btnPacienteCor1 = document.getElementsByClassName("_nav-item-programacao");//cor
  class_add_toggle(btnPacienteCor1,"verde-92D050");
  
  var btnPacienteCor1 = document.getElementsByClassName("nav-programacao-filho");
  class_add_toggle(btnPacienteCor1,"verde-568132");

}

function drop_monitoramentos(var_1,var_2,var_3,var_4) {

  menu_close(var_1,var_2,var_3,var_4);

  var btnUpPaciente = document.getElementById("ico-monitoramento");
  class_toggle_by_id(btnUpPaciente,"icofont-simple-down","icofont-simple-up");

  var proprerty_ = document.getElementsByClassName("_nav-monitoramento-filho");//aparecerFilhos
  class_toggle(proprerty_,"w3-hide","w3-show");

  var btnPacienteCor1 = document.getElementsByClassName("_nav-item-monitoramento");//cor
  class_add_toggle(btnPacienteCor1,"verde-92D050");
  
  var btnPacienteCor1 = document.getElementsByClassName("_nav-monitoramento-filho"); 
  class_add_toggle(btnPacienteCor1,"verde-568132");
