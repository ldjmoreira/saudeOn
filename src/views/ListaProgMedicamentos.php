...
?>
    ...
    <div class="caixa-lista-paciente">  
        ...
        <div class="mb-4  posicao-form " >
                ...
                <a class="registro posicao-form-esquerda-2" ´
                href="ProgMedicamentos.php"> 
                <i class="icofont-plus-circle h4 mt-1   mr-2 "></i> 
                <h4>Adicionar novo registro </h4>
                </a>

                <a class="registro posicao-form-center-2" ´
                href="ListaMedicamentosAll.php"> 
                <i class="icofont-list h4 mt-1   mr-2 "></i> 
            ...
            <table class="table table-bordered table-striped table-hover" id="myTable">
                ...
                <tbody>
                    <?php     
                        ...
                        <tr>
                        <td><?= $medicamento->name ." " . $medicamento->apresentacao ?></td>
                        <td><?= $medicamento->dose?></td>
                        <td><?= $medicamento->via?></td>
                        <td>
                            <?php 
                            if($medicamento->intervalo == 0){
                                echo "Uma única vez";
                            }
                            elseif($medicamento->intervalo < 60) { 
                                echo $medicamento->intervalo." Minutos";}
                            elseif ($medicamento->intervalo == 60) {
                                echo round($medicamento->intervalo/60,2 )." Hora";
                            }elseif($medicamento->intervalo > 60 && $medicamento->intervalo < 1440){echo round($medicamento->intervalo/60,0) ." Horas ". ($medicamento->intervalo%60 == 0 ? '':'e ' . $medicamento->intervalo%60 . "minutos" ) ;
                            } else{
                                echo round($medicamento->intervalo/(60*24),0) . " dias";
                            } 
                            ?>
                        </td>
                        <td><?= $medicamento->datahora?></td>
                        <td><?= $medicamento->hora?></td>
                        <td><?= $medicamento->ciente ? "Sim" : "Não"; ?></td>
                        <td><?= $medicamento->aprazada ? "Sim" : "Não"; ?></td>
                        <td>
