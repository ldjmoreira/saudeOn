<aside class="sidebar">
    ...
    <nav class="menu2 mt-3">
            ...
            <?php foreach($listadeEvolucao as $dados): ?>
                <ul class="nav-list">
                    <li class="nav-item" id="lista-<?= $dados->evolucao_id ?>">
                        <a href="Evolucao2.php?paciente2=<?=$dados->id ?>&id=<?= $dados->evolucao_id ?>">
                                <div class="lateral-nome">
                                    <?= $dados->data_evolucao ?> - <?= $dados->nome_prof ?>
                                </div>
                        </a>
                    </li>
                </ul>
