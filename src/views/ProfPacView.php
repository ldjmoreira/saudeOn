            ...
            <div class="caixa-padrao-conteudo">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <select disabled name="profissional" id="profissional" class="form-control <?= $errors['profissional'] ? 'is-invalid' : '' ?>" >
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select disabled name="turno" id="turno" class="form-control <?= $errors['data'] ? 'is-invalid' : '' ?>" >
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="number" id="duracao" name="duracao" readonly
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select readonly name="periodicidade" id="periodicidade" class="form-control" >
                            ...
                            <?php
                                ...
                                if(strpos($pieces[1],'view') !== false){
                            ?>
                            <div class="form-group col-md-1">
                                <label for="is_admin" class="ml-3"> Remover</label>
