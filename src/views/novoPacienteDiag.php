    ...
    <form action="#" method="post" id="idOfForm">
        ...
        <div class="caixa-padrao">  
                <div class="caixa-padrao-titulo">
                    <h3>perfil paciente: Dados Gerais (diag)</h3>
                </div>
            ...
            <div class="caixa-padrao-conteudo">
                        ...
                        <input type="hidden" name="concentradorBanco" value="<?= $concentradorBanco->concentrador  ?>">
            ...
            <div class="caixa-padrao-conteudo">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="concentrador" id="concentrador" class="form-control" >
                                <option value="">Selecionar</option>
                                    <?php     

                                        foreach($concentradorPoss as $unic) {
                                            $selected = $unic->concentrador === $paciente[0]->concentrador ? 'selected' : '';
                                            echo "<option value='{$unic->concentrador}' {$selected} >{$unic->concentrador}</option>";
                                        }
                                            echo "<option value='{$paciente[0]->concentrador}' selected >{$paciente[0]->concentrador}</option>";
                                    ?>
                                </select>
                                <div class="invalid-feedback">
                                    <?= $errors['profissional'] ?>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pressaoSistolica" name="pressaoSistolica" placeholder="anote alguma observação"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="pressaoDiastolica" name="pressaoDiastolica" placeholder="anote alguma observação"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="maoDominante" name="maoDominante" placeholder="anote alguma observação"
