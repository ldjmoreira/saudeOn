            ...
            <table class="table table-bordered table-striped table-hover" id="myTable">
                ...
                <tbody>
                    <?php     
                        ...
                        <td><?= $SinaisVital->intervalo > 1 ? $SinaisVital->intervalo . " minutos" : $SinaisVital->intervalo . " minuto"; ?></td>
                        ...
                        <a id="myDelete" href="?delete=<?= $SinaisVital->id ?>" onclick="myDeletes(event,this,<?= $paciente->id ?>)"
                            class="btn btn-danger  rounded-circle   ml-2">
