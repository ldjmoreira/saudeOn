...
class Paciente extends Model {
    ...
    public static function getListaEmergencia($arg){
        ...
        $sql ="SELECT 
        ocorrencia_emergencias.id,
        tipos_de_emergencias.descricao, 
        ocorrencia_emergencias.datainclusao,
        ocorrencia_emergencias.dataCiencia, 
        users.name
        FROM ocorrencia_emergencias 
        INNER JOIN monitoramentos ON ocorrencia_emergencias.concentrador = monitoramentos.concentrador
        INNER JOIN users ON ocorrencia_emergencias.operador = users.id 
        INNER JOIN pacientes ON monitoramentos.paciente = pacientes.id 
        INNER JOIN tipos_de_emergencias ON ocorrencia_emergencias.id_tipo_emergencia= tipos_de_emergencias.id
    ...
    public static function SelectOne2($arg2){
        ...
        pacientes.dataNasc 
        FROM pacientes 
        inner join monitoramentos on monitoramentos.paciente = pacientes.id
    ...
    public static function paciente_concentrador2(){
        ...
        equipo_concentrador.start_date as dataAdmissao,
    ...
    public static function paciente_ListaConcentrador(){
        $objects = [];
        ...
        pacientes.dataAdmissao,pacientes.prontuario,
         monitoramentos.concentrador
          FROM pacientes 
          LEFT JOIN monitoramentos ON pacientes.id = monitoramentos.paciente
          WHERE pacientes.softdelete = 0 AND monitoramentos.equipo = 0
          ORDER BY pacientes.id DESC
        ");
    ...
    public static function paciente_ListaConcentradorById($id){
        $objects = [];
        ...
        pacientes.dataAdmissao,pacientes.prontuario,
         monitoramentos.concentrador
          ...
          LEFT JOIN monitoramentos ON pacientes.id = monitoramentos.paciente
          WHERE pacientes.softdelete = 0 
          AND monitoramentos.paciente = $id
          ORDER BY pacientes.id DESC
        ");
